...
import type {
    ...
    TargetGroupFilter,
} from "../interface/StudentActivitiesComputer.interface";

import {
    CheckInStudentActivitiesComputer,
    CheckOutStudentActivitiesComputer,
...
export const useStudentActivitiesComputerForm = () => {
    ...
    const handleSubmit = async (rawValue = qrText) => {
        ...
        try {
            ...
            if (mode === "checkin") {
                const res = await CheckInStudentActivitiesComputer({
                ...
                handleResultMessage(
                    "success",
                    res.detail || "เช็คอินสำเร็จ"
                );
            } else {
                const res = await CheckOutStudentActivitiesComputer({
                    student_code: payload.student_code,
                    activity_id: activityId,
                    updated_by_name:
                        localStorage.getItem("account_name") || "admin",
    ...
    return {
        ...
        selectedActivity,
        filteredActivities,
        activity_filter_Loading: activityFilterLoading,
...
export type IUseStudentActivitiesComputerForm = ReturnType<
    typeof useStudentActivitiesComputerForm
>;