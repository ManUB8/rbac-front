...
export interface IMobileStaffProductProps {
...
const MobileStaffProduct: React.FunctionComponent<IMobileStaffProductProps> = ({
    product_data,
    getValues,
    setValue,
    open,
    ...
    const initialPosDevice = useMemo(() => {
        const idx = (formDevicePerms as any[]).findIndex(
            d => d?.product_device_id === '3' || d?.product_device_name === 'mobile-staff'
        );
...
export default MobileStaffProduct;