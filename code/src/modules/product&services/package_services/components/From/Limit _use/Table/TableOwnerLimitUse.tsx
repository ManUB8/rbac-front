...
export interface ITableOwnerLimitUseProps {
    owner_data: IDataMetric[]
...
const TableOwnerLimitUse: React.FunctionComponent<ITableOwnerLimitUseProps> = ({
    owner_data,
    getValues,
    setValue,
    watch,
    ...
    const mergedRows = useMergedMetrics(owner_data, formMetrics);
...
export default TableOwnerLimitUse;