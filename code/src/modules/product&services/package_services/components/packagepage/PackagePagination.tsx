...
import { searchStatePackage } from '../../hook/AtomPackageServices';

export interface IPackagePaginationProps {
    total: number;
};

const PackagePagination: React.FunctionComponent<IPackagePaginationProps> = ({
    total
}) => {
    const theme = useTheme();
    const [search, setSearch] = useAtom(searchStatePackage);
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Typography variant='subtitle2' sx={{ color: "#667085", ml: 0.5 }}>จาก {total}</Typography>
